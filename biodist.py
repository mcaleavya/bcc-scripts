#!/usr/bin/python
#
# bitehist.py   Block I/O sector histogram.
...
#
# 11-Apr-2016 Allan McAleavy ran pep8 against file
...
int do_count(struct pt_regs *ctx, struct request *req)
{
    ...
    if (req->__sector > 0) {
        struct proc_key_t key = {.slot = bpf_log2l(req->__sector)};
...
try:
    ...
    dist.print_log2_hist("Sector", "Process Name")
